...
export default function CollectionPage() {
  ...
  if (filters.color) {
    filteredProducts = filteredProducts.filter((p) => p.colors.some((c) => c.name === filters.color))
  }
  if (filters.vesselMaterial) {
    filteredProducts = filteredProducts.filter((p) => p.vesselMaterial === filters.vesselMaterial)
  }
  if (filters.vesselShape) {
    filteredProducts = filteredProducts.filter((p) => p.vesselShape === filters.vesselShape)
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-between items-center mt-8 mb-4">
        <span className="text-sm uppercase tracking-wide">{filteredProducts.length} PRODUCTS</span>
